...
- Create Angular project with ng: `ng new npgkanbanstyletaskboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`npgkanbanstyletaskboard.client.esproj`).
